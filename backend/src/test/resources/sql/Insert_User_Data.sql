...
INSERT INTO users (id, encrypted_password, first_name, last_name, username, user_details_id, email_verification_status)
            VALUES(1000, '$2a$10$.bFiSkEQ/XvVSc730N9Ma..8GIye169e4xiDMqyO4waihB8YZadGi', 'fName_1', 'lName_1', 'username_1', 2000, 0);
INSERT INTO users (id, encrypted_password, first_name, last_name, username, user_details_id, email_verification_status)
            VALUES(1001, '$2a$10$42I4jZGwnEYJGkMLDu4t6u/DoP.cKQXLRIX7bgXN6Mz2bV3.TTg3C', 'fName_2', 'lName_2', 'username_2', 2001, 0);
INSERT INTO users (id, encrypted_password, first_name, last_name, username, user_details_id, email_verification_status)
            VALUES(1002, '$2a$10$rHx7Ay5m9QE1.Raa2v16ROLhASbMc8WCSyk8kQy1BoVhJWEO0KETm', 'fName_3', 'lName_3', 'username_3', 2002, 0);
INSERT INTO users (id, encrypted_password, first_name, last_name, username, user_details_id, email_verification_status)
            VALUES(1003, '$2a$10$GI5oyzIPmMK249QpZrABM.UwELVBPTeXH/lQjYcKYuc2BvpxfnqXm', 'fName_4', 'lName_4', 'username_4', 2003, 0);
